...
${
  ...
  - Clone target repository: Bash(gh repo clone <owner>/<repo_name> ${process.env.RUNNER_TEMP}/<repo_name>_<timestamp> -- -b ${process.steps.set-base-branch.outputs.base_branch})
  - Stage files: Bash(git add <files>)
